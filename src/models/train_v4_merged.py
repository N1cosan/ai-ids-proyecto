...
if __name__ == "__main__":
    ...
    joblib.dump(model, MODEL_DIR / "rf_model_v4_merged.joblib")
    joblib.dump(label_encoder, MODEL_DIR / "label_encoder_v4_merged.joblib")
    joblib.dump(list(X.columns), MODEL_DIR / "feature_columns_v4_merged.joblib")
